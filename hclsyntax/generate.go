...
//go:generate ruby unicode2ragel.rb --url=https://www.unicode.org/Public/17.0.0/ucd/DerivedCoreProperties.txt -m UnicodeDerived -p ID_Start,ID_Continue -o unicode_derived.rl
